...
copyright = '2025, Nicolas Bruschi 😀'
# pylint: disable=invalid-name
author = 'Nicolas Bruschi'
...
html_logo = 'Outils.png'
html_favicon = 'Outils.ico'
...
latex_documents = [
  (master_doc, 'Outils.tex', 'Outils Documentation', \
    [author], 'manual'),]
...
man_pages = [
  (master_doc, 'Outils', 'Outils Documentation', \
    [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'Outils', 'Outils Documentation', \
    author, 'Outils', 'Doc forge logicielle.', \
    'Miscellaneous'),
]
